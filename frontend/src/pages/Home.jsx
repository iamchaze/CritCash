      ...
      <div className="">
        ...
        <div className="lg:flex lg:gap-5 lg:items-center lg:justify-between lg:px-25 lg:py-10 transition-all duration-500 ease-in-out">
          <div className="order-2 w-auto">
            <img
              className="mx-auto mt-10 w-full h-full lg:w-120 lg:h-120 max-w-100 lg:max-w-120 transition-all duration-500 ease-in-out"
              src="/images/e9f1c2c368f1f9d97982078a54d90e81c5d8cdf5.png"
              alt="no image found"
            />
          </div>
          <div className="order-1 ml-5 pb-10 lg:ml-0 lg:pb-0 lg:text-left transition-all duration-500 ease-in-out">
            ...
            <div className="lg:flex lg:items-center lg:space-between">
              <div className="inline-block mt-8 bg-button1 text-white py-4 px-8 rounded-full font-bold text-2xl font-[REM]  hover:translate-y-[-0.1rem] hover:shadow-lg transition-all duration-200 ease-in-out active:translate-0.5 active:bg-accent5 cursor-pointer">
        ...
        <div className="font-[REM] text-md italic lg:my-30">
